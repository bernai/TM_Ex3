...
# get list of german stopwords, more complete than nltk's version
data = requests.get('https://raw.githubusercontent.com/stopwords-iso/stopwords-de/master/stopwords-de.txt').text
stop_words = data.split('\n')
stop_words.extend(['sp_fraktion', 'svp_fraktion', 'herr', 'frau', 'herrn'])
